...
models = [
    ...
    Model(
        ...
        filename='bvlc_reference_rcnn_ilsvrc13_f8f35d6.tar.gz'),
    Model(
        name='RCNN_ILSVRC13 (ONNX)',
        archive='bvlc_reference_rcnn_ilsvrc13_f8f35d6.tar.gz',
        member='model/model.onnx',
        sha='fbf174b62a1918bff43c0287e41fdc6017b46256',
        filename='onnx/models/rcnn_ilsvrc13_fbf174b.onnx'),
    Model(
        name='RCNN_ILSVRC13 (ONNX)',
        ...
        filename='onnx/data/input_rcnn_ilsvrc13_fbf174b.pb'),
    Model(
        name='RCNN_ILSVRC13 (ONNX)',
        archive='bvlc_reference_rcnn_ilsvrc13.tar.gz',
        member='model/test_data_set_0/output_0.pb',
        sha='632447fa62b1480d1fc4dc061470b69a2915b29f',
        filename='onnx/data/output_rcnn_ilsvrc13_fbf174b.pb'),
    Model(
        name='ZFNet512 (ONNX)',
        ...
        filename='zfnet512_920bc80.tar.gz'),
    Model(
        name='ZFNet512 (ONNX)',
        archive='zfnet512_920bc80.tar.gz',
        member='model/model.onnx',
        sha='c32b9ae0bbe65e2ee60f98639b170645000e2c75',
        filename='onnx/models/zfnet512_c32b9ae.onnx'),
    Model(
        name='ZFNet512 (ONNX)',
        archive='zfnet512.tar.gz',
        member='model/test_data_set_0/input_0.pb',
        sha='0668bee1a3790c20e84ce1e39bcefd1b28507afe',
        filename='onnx/data/input_zfnet512_c32b9ae.pb'),
    Model(
        name='ZFNet512 (ONNX)',
        archive='zfnet512.tar.gz',
        member='model/test_data_set_0/output_0.pb',
        sha='b51c03cca2d91d5167a5e68d45a8506efa8330d4',
        filename='onnx/data/output_zfnet512_c32b9ae.pb'),
    Model(
        name='VGG16_bn (ONNX)',
    ...
    Model(
        ...
        filename='mnist_a43da52.tar.gz'),
    Model(
        name='CNN Mnist (ONNX)',
        archive='mnist_a43da52.tar.gz',
        member='model/model.onnx',
        sha='e4fb4914cd1d9e0faed3294e5cecfd1847339763',
        filename='onnx/models/cnn_mnist_a43da52.onnx'),
    Model(
        name='CNN Mnist (ONNX)',
        archive='mnist.tar.gz',
        member='model/test_data_set_0/input_0.pb',
        sha='8fe4004a58792f7003e824c2722436ecf50c1ff6',
        filename='onnx/data/input_cnn_mnist_a43da52.pb'),
    Model(
        name='CNN Mnist (ONNX)',
        archive='mnist.tar.gz',
        member='model/test_data_set_0/output_0.pb',
        sha='6d7ebb306514e3c8d5aa463aa3f916f142f1bbc4',
        filename='onnx/data/output_cnn_mnist_a43da52.pb'),
    Model(
    ...
    Model(
        ...
        filename='emotion_ferplus_ff01844.tar.gz'),
    Model(
        name='Emotion FERPlus (ONNX)',
        archive='emotion_ferplus_ff01844.tar.gz',
        member='model/model.onnx',
        sha='2ef5b3a6404a5feb8cc396d66c86838c4c750a7e',
        filename='onnx/models/emotion_ferplus_2ef5b3a.onnx'),
    Model(
        name='Emotion FERPlus (ONNX)',
        archive='emotion_ferplus.tar.gz',
        member='model/test_data_set_0/input_0.pb',
        sha='c9d146c1a958685a7ee9fe4cb107b3a382235b71',
        filename='onnx/data/input_emotion_ferplus_2ef5b3a.pb'),
    Model(
        name='Emotion FERPlus (ONNX)',
        archive='emotion_ferplus.tar.gz',
        member='model/test_data_set_0/output_0.pb',
        sha='0cabb8a59a56b85d6cb425c94de542cfc9dadada',
        filename='onnx/data/output_emotion_ferplus_2ef5b3a.pb'),
    Model(
        ...
        filename='squeezenet_b6fef64.tar.gz'),
    Model(
        name='Squeezenet (ONNX)',
        archive='squeezenet_b6fef64.tar.gz',
        member='model/model.onnx',
        sha='c3f272e672fa64a75fb4a2e48dd2ca25fcc76c49',
        filename='onnx/models/squeezenet_b6fef64.onnx'),
    Model(
        name='Squeezenet (ONNX)',
        archive='squeezenet.tar.gz',
        member='model/test_data_set_0/input_0.pb',
        sha='a802b4ff71cfd42eb76ca49a1408b3292150db06',
        filename='onnx/data/input_squeezenet_b6fef64.pb'),
    Model(
        name='Squeezenet (ONNX)',
        archive='squeezenet.tar.gz',
        member='model/test_data_set_0/output_0.pb',
        sha='6db0fdc10cf05d2fd148a53852c7daac7a6aac18',
        filename='onnx/data/output_squeezenet_b6fef64.pb'),
    Model(
    ...
    Model(
        ...
        filename='shufflenet_dd66a54.tar.gz'),
    Model(
        name='Shufflenet (ONNX)',
        archive='shufflenet_dd66a54.tar.gz',
        member='model/model.onnx',
        sha='a781faf9f1fe6d001cd7b6b5a7d1a228da0ff17b',
        filename='onnx/models/shufflenet_dd66a54.onnx'),
    Model(
        name='Shufflenet (ONNX)',
        archive='shufflenet_dd66a54.tar.gz',
        member='model/test_data_set_0/input_0.pb',
        sha='cd98071ebd437a5c64265fe3762302496ad6c8e0',
        filename='onnx/data/input_shufflenet_dd66a54.pb'),
    Model(
        name='Shufflenet (ONNX)',
        archive='shufflenet_dd66a54.tar.gz',
        member='model/test_data_set_0/output_0.pb',
        sha='dd437c70b08027f17e94ef8a9156e0a60c21d2f5',
        filename='onnx/data/output_shufflenet_dd66a54.pb'),
    Model(
