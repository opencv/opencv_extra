...
models = [
    ...
    Model(
        name='NanoTrack (ONNX)',
        url='https://github.com/zihaomu/opencv_extra_data_backup/raw/main/NanoTrack/models/nanotrack_backbone_sim.onnx',
        sha='9b083a2dbe10dcfe17e694879aa6749302a5888f',
        filename='onnx/models/nanotrack_backbone_sim.onnx'),
    Model(
        name='NanoTrack (ONNX)',
        url='https://github.com/zihaomu/opencv_extra_data_backup/raw/main/NanoTrack/models/nanotrack_head_sim.onnx',
