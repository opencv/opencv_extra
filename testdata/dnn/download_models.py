...
models = [
    ...
    Model(
        ...
        url='https://huggingface.co/litert-community/MobileNet-v2/resolve/main/mobilenet_v2.tflite',
        sha='490bfe16fb5fd4e52172422f163231fac174a8b2',
        filename='tflite/mobilenet_v2.tflite'),
    Model(
        name='ResNet-18 (TFLite)',
        url='https://huggingface.co/litert-community/resnet18/resolve/main/resnet18.tflite',
        sha='8cb8b092147a3a97f9490120d73fc3807792f8d7',
        filename='tflite/resnet18.tflite'),
    Model(
        name='SqueezeNet v1.1 (TFLite)',
        url='https://huggingface.co/litert-community/squeezenet1_1/resolve/main/squeezenet1_1.tflite',
        sha='ff9ff5b359e32ec31ee6174f573bf990713727b6',
        filename='tflite/squeezenet1_1.tflite'),
    Model(
        name='YOLOv8n (TFLite)',
        url='https://huggingface.co/opencv/opencv_contribution/resolve/main/yolov8n/yolov8n.tflite',
        sha='30a403b7698dbff8c4474e4a26959ba3af94cf21',
        filename='tflite/yolov8n.tflite'),
    Model(
        name='YOLOv5nu (TFLite)',
        url='https://huggingface.co/opencv/opencv_contribution/resolve/main/yolov5nu/yolov5nu.tflite',
        sha='abab2a8ff26d998ab86a8a3ee09dc69a40bea32d',
        filename='tflite/yolov5nu.tflite'),
    Model(
        name='YOLO26n (TFLite)',
        url='https://huggingface.co/opencv/opencv_contribution/resolve/main/yolo26n/yolo26n.tflite',
        sha='a844afacbd6f00e5d84ae79f5f76ea24b5f1d840',
        filename='tflite/yolo26n.tflite'),
    Model(
        name='YOLO26n-seg (TFLite)',
        url='https://huggingface.co/opencv/opencv_contribution/resolve/main/yolo26n-seg/yolo26n-seg.tflite',
        sha='794d80d4878932e8c143610bb0d9b495cfa9fb26',
        filename='tflite/yolo26n-seg.tflite'),
    Model(
        name='YuNet (TFLite)',
        url='https://github.com/Kazuhito00/YuNet-ONNX-TFLite-Sample/raw/main/model/model_float32.tflite',
